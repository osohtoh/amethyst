...
def general_sub(
    ...
    Args:
        core_mol (Mol): Scaffold, R attachment points have to be labelled in atom map format - [*:#], if not set relabelled to False.
    ...
    combinations: list[tuple[Mol]] = [x for x in itertools.product(*r_groups)]
